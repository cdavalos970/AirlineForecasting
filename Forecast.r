library(forecast)
setwd("C:/Users/cdavalos/Documents/Pronostico TM/R/Pronosticos/HW")
#Lee el archivo
...
F_forecast_Pax_Real <- data.frame()
F_forecast_USD_Real <- data.frame()
F_forecast_COP_Real <- data.frame()

F_forecast_Pax_Outlier <- data.frame()
F_forecast_Rev_USD_Outlier <- data.frame()
F_forecast_Rev_COP_Outlier <- data.frame()

F_forecast_Error_Pax_Real <- data.frame()
F_forecast_Error_USD_Real <- data.frame()
F_forecast_Error_COP_Real <- data.frame()

F_forecast_Error_Pax_Outlier <- data.frame()
F_forecast_Error_Rev_USD_Outlier <- data.frame()
F_forecast_Error_Rev_COP_Outlier <- data.frame()
...
#i=3
   ...
   fit <- forercast(train)                                                                                                            #Corre HW
   prueba <- as.data.frame(fit[2])[c(1,2,3),1]
...
HW_Pax_Real <- HoltWinters(ts_Pax_Real)
Indicadores_Pax_Real <- getrmse(ts_Pax_Real, forecast_periods, iterations)
HW_Rev_USD_Real <- HoltWinters(ts_Rev_USD_Real)
Indicadores_Rev_USD_Real <- getrmse(ts_Rev_USD_Real, forecast_periods, iterations)
HW_Rev_COP_Real <- HoltWinters(ts_Rev_COP_Real)
Indicadores_Rev_COP_Real <- getrmse(ts_Rev_COP_Real, forecast_periods, iterations)

HW_Pax_Outlier <- HoltWinters(ts_Pax_Outlier)
Indicadores_Pax_Outlier  <- getrmse(ts_Pax_Outlier, forecast_periods, iterations)
HW_Rev_USD_Outlier <- HoltWinters(ts_Rev_USD_Outlier)
Indicadores_Rev_USD_Outlier  <- getrmse(ts_Rev_USD_Outlier, forecast_periods, iterations)
HW_Rev_COP_Outlier <- HoltWinters(ts_Rev_COP_Outlier)
Indicadores_Rev_COP_Outlier  <- getrmse(ts_Rev_COP_Outlier, forecast_periods, iterations)

matriz_Pax_Real <- rbind(matriz_Pax_Real,as.data.frame(forecast(HW_Pax_Real))[c(1,2,3),1])
matriz_Rev_USD_Real <- rbind(matriz_Rev_USD_Real,as.data.frame(forecast(HW_Rev_USD_Real))[c(1,2,3),1])
matriz_Rev_COP_Real <- rbind(matriz_Rev_COP_Real,as.data.frame(forecast(HW_Rev_COP_Real))[c(1,2,3),1])

matriz_Pax_Outlier <- rbind(matriz_Pax_Outlier,as.data.frame(forecast(HW_Pax_Outlier))[c(1,2,3),1])
matriz_Rev_USD_Outlier <- rbind(matriz_Rev_USD_Outlier,as.data.frame(forecast(HW_Rev_USD_Outlier))[c(1,2,3),1])
matriz_Rev_COP_Outlier <- rbind(matriz_Rev_COP_Outlier,as.data.frame(forecast(HW_Rev_COP_Outlier))[c(1,2,3),1])
...
HW_forecast_Pax_Real <- t(matriz_Pax_Real)
HW_forecast_USD_Real <- t(matriz_Rev_USD_Real)
HW_forecast_COP_Real <- t(matriz_Rev_COP_Real)

HW_forecast_Pax_Outlier <- t(matriz_Pax_Outlier)
HW_forecast_Rev_USD_Outlier <- t(matriz_Rev_USD_Outlier)
HW_forecast_Rev_COP_Outlier <- t(matriz_Rev_COP_Outlier)
...
colnames(HW_forecast_Pax_Real) <- colnames(Pax_Real)
colnames(HW_forecast_USD_Real) <- colnames(Pax_Real)
colnames(HW_forecast_COP_Real) <- colnames(Pax_Real)

colnames(HW_forecast_Pax_Outlier) <- colnames(Pax_Real)
colnames(HW_forecast_Rev_USD_Outlier) <- colnames(Pax_Real)
colnames(HW_forecast_Rev_COP_Outlier) <- colnames(Pax_Real)
...
rownames(HW_forecast_Pax_Real) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
rownames(HW_forecast_USD_Real) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
rownames(HW_forecast_COP_Real) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)

rownames(HW_forecast_Pax_Outlier) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
rownames(HW_forecast_Rev_USD_Outlier) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
rownames(HW_forecast_Rev_COP_Outlier) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
...
write.table(file="PAX_Outliers.csv",HW_forecast_Pax_Real)
write.table(file="REV_USD_Outliers.csv",HW_forecast_USD_Real)
write.table(file="REV_COP_Outliers.csv",HW_forecast_COP_Real)

write.table(file="PAX_Real.csv",HW_forecast_Pax_Outlier)
write.table(file="REV_USD_Real.csv",HW_forecast_Rev_USD_Outlier)
write.table(file="REV_COP_Real.csv",HW_forecast_Rev_COP_Outlier)

setwd("C:/Users/cdavalos/Documents/Pronostico TM/R/Indicadores/HW")
