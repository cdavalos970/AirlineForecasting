...
cantDatos <- nrow(Pax_Real[posLeg])
	...
	matriz_Pax_Real <- rbind(matriz_Pax_Real,as.data.frame(forecast(STS_Pax_Real))[periods,1])
	...
	matriz_Pax_Outlier <- rbind(matriz_Pax_Outlier,as.data.frame(forecast(STS_Pax_Outlier))[periods,1])
	...
	matriz_Rev_USD_Real <- rbind(matriz_Rev_USD_Real,as.data.frame(forecast(STS_Rev_USD_Real))[periods,1])
	...
	matriz_Rev_USD_Outlier <- rbind(matriz_Rev_USD_Outlier,as.data.frame(forecast(STS_Rev_USD_Outlier))[periods,1])
	...
	matriz_Rev_COP_Real <- rbind(matriz_Rev_COP_Real,as.data.frame(forecast(STS_Rev_COP_Real))[periods,1])
	} else {
	...
	matriz_Rev_COP_Outlier <- rbind(matriz_Rev_COP_Outlier,as.data.frame(forecast(STS_Rev_COP_Outlier))[periods,1])
...
colnames(STS_forecast_Pax_Real) <- as.character(Pax_Real_Leg)
colnames(STS_forecast_USD_Real) <- as.character(REV_USD_Real_Leg)
colnames(STS_forecast_COP_Real) <- as.character(Rev_COP_Real_Leg)

colnames(STS_forecast_Pax_Outlier) <- as.character(Pax_Outlier_Leg)
colnames(STS_forecast_Rev_USD_Outlier) <- as.character(REV_USD_Outliers_Leg)
colnames(STS_forecast_Rev_COP_Outlier) <- as.character(Rev_COP_Outliers_Leg)
