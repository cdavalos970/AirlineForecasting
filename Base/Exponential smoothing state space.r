library(forecast)
setwd("C:/Users/cdavalos/Documents/Pronostico TM/R/Pronosticos/ETS")
#Lee el archivo
...
ets_additive_forecast_Pax_Real <- data.frame()
ets_additive_forecast_USD_Real <- data.frame()
ets_additive_forecast_COP_Real <- data.frame()

ets_additive_forecast_Pax_Outlier <- data.frame()
ets_additive_forecast_Rev_USD_Outlier <- data.frame()
ets_additive_forecast_Rev_COP_Outlier <- data.frame()
...
ets_additive_Pax_Real <- as.data.frame(forecast(ets(ts_Pax_Real)))[c(1,2,3),1]
Indicadores_Pax_Real <- getrmse(ts_Pax_Real, forecast_periods, iterations)
ets_additive_Rev_USD_Real <- as.data.frame(forecast(ets(ts_Rev_USD_Real)))[c(1,2,3),1]
Indicadores_Rev_USD_Real <- getrmse(ts_Rev_USD_Real, forecast_periods, iterations)
ets_additive_Rev_COP_Real <- as.data.frame(forecast(ets(ts_Rev_COP_Real)))[c(1,2,3),1]
Indicadores_Rev_COP_Real <- getrmse(ts_Rev_COP_Real, forecast_periods, iterations)

ets_additive_Pax_Outlier <- as.data.frame(forecast(ets(ts_Pax_Outlier)))[c(1,2,3),1]
Indicadores_Pax_Outlier  <- getrmse(ts_Pax_Outlier, forecast_periods, iterations)
ets_additive_Rev_USD_Outlier <- as.data.frame(forecast(ets(ts_Rev_USD_Outlier)))[c(1,2,3),1]
Indicadores_Rev_USD_Outlier  <- getrmse(ts_Rev_USD_Outlier, forecast_periods, iterations)
ets_additive_Rev_COP_Outlier <- as.data.frame(forecast(ets(ts_Rev_COP_Outlier)))[c(1,2,3),1]
Indicadores_Rev_COP_Outlier  <- getrmse(ts_Rev_COP_Outlier, forecast_periods, iterations)

matriz_Pax_Real <- rbind(matriz_Pax_Real,as.data.frame(ets_additive_Pax_Real)[c(1,2,3),1])
matriz_Rev_USD_Real <- rbind(matriz_Rev_USD_Real,as.data.frame(ets_additive_Rev_USD_Real)[c(1,2,3),1])
matriz_Rev_COP_Real <- rbind(matriz_Rev_COP_Real,as.data.frame(ets_additive_Rev_COP_Real)[c(1,2,3),1])

matriz_Pax_Outlier <- rbind(matriz_Pax_Outlier,as.data.frame(ets_additive_Pax_Outlier)[c(1,2,3),1])
matriz_Rev_USD_Outlier <- rbind(matriz_Rev_USD_Outlier,as.data.frame(ets_additive_Rev_USD_Outlier)[c(1,2,3),1])
matriz_Rev_COP_Outlier <- rbind(matriz_Rev_COP_Outlier,as.data.frame(ets_additive_Rev_COP_Outlier)[c(1,2,3),1])
...
ets_additive_forecast_Pax_Real <- t(matriz_Pax_Real)
ets_additive_forecast_USD_Real <- t(matriz_Rev_USD_Real)
ets_additive_forecast_COP_Real <- t(matriz_Rev_COP_Real)

ets_additive_forecast_Pax_Outlier <- t(matriz_Pax_Outlier)
ets_additive_forecast_Rev_USD_Outlier <- t(matriz_Rev_USD_Outlier)
ets_additive_forecast_Rev_COP_Outlier <- t(matriz_Rev_COP_Outlier)
...
colnames(ets_forecast_Pax_Real) <- colnames(Pax_Real)
colnames(ets_forecast_USD_Real) <- colnames(Pax_Real)
colnames(ets_forecast_COP_Real) <- colnames(Pax_Real)

colnames(ets_forecast_Pax_Outlier) <- colnames(Pax_Real)
colnames(ets_forecast_Rev_USD_Outlier) <- colnames(Pax_Real)
colnames(ets_forecast_Rev_COP_Outlier) <- colnames(Pax_Real)
...
rownames(ets_forecast_Pax_Real) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
rownames(ets_forecast_USD_Real) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
rownames(ets_forecast_COP_Real) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)

rownames(ets_forecast_Pax_Outlier) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
rownames(ets_forecast_Rev_USD_Outlier) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
rownames(ets_forecast_Rev_COP_Outlier) <- seq(as.Date("2015/1/1"),by = "month", length.out = forecast_periods)
...
write.table(file="PAX_Outliers.csv",ets_additive_forecast_Pax_Real)
write.table(file="REV_USD_Outliers.csv",ets_additive_forecast_USD_Real)
write.table(file="REV_COP_Outliers.csv",ets_additive_forecast_COP_Real)

write.table(file="PAX_Real.csv",ets_additive_forecast_Pax_Outlier)
write.table(file="REV_USD_Real.csv",ets_additive_forecast_Rev_USD_Outlier)
write.table(file="REV_COP_Real.csv",ets_additive_forecast_Rev_COP_Outlier)
