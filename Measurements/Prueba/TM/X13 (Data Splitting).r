...
TMPAXOUTLIERvsREVREAL <- TMPAXOUTLIERvsREVREAL[-c(6,136)]
...
TMPAXREALvsREVOUTLIER <- TMPAXREALvsREVOUTLIER[-c(79)]
TMPAXREALvsREVREAL <- read.table(Input_TMPAXREALvsREVREAL, sep=" ", header=TRUE, fileEncoding="latin1") 
TMPAXREALvsREVREAL <- TMPAXREALvsREVREAL[-c(6,41,78)]
...
setwd("C:/Users/cdavalos/Documents/Pronostico TM/R/Indicadores/Prueba/TM/X13")
...
setwd("C:/Users/cdavalos/Documents/Pronostico TM/R/Prueba/Datos Data Splitting/TM/X13")
