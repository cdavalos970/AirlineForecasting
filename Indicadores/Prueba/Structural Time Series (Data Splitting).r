...
colnames(STS_forecast_Error_USD_Real) <- colnames(Rev_USD_Real)
colnames(STS_forecast_Error_COP_Real) <- colnames(Rev_COP_Real)

colnames(STS_forecast_Error_Pax_Outlier) <- colnames(Pax_Outliers)
colnames(STS_forecast_Error_Rev_USD_Outlier) <- colnames(Rev_USD_Outliers)
colnames(STS_forecast_Error_Rev_COP_Outlier) <- colnames(Rev_COP_Outliers)
...
setwd("C:/Users/cdavalos/Documents/Pronostico TM/R/Indicadores/Prueba/STS")
...
setwd("C:/Users/cdavalos/Documents/Pronostico TM/R/Prueba/Datos Data Splitting/STS")
